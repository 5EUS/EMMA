...
/// <summary>
/// Describes the standard JSON metadata and default responses used by <see cref="PluginBasicVideoWasmOperationHost{TChapterOperationItem}"/>.
/// </summary>
...
/// <param name="VideoStreamArrayTypeInfo">The JSON type metadata for <see cref="VideoStreamOperationItem"/> arrays.</param>
/// <param name="VideoSegmentTypeInfo">The JSON type metadata for <see cref="VideoSegmentOperationItem"/>.</param>
...
public sealed record PluginBasicVideoWasmHostOptions<TChapterOperationItem>(
    ...
    JsonTypeInfo<VideoStreamOperationItem[]> VideoStreamArrayTypeInfo,
    JsonTypeInfo<VideoSegmentOperationItem> VideoSegmentTypeInfo,
...
/// <summary>
/// Provides a reusable WASM host implementation for basic video plugins that fetch payloads from an external provider.
/// </summary>
/// <typeparam name="TChapterOperationItem">The serialized chapter-operation item type used for invoke responses.</typeparam>
public abstract class PluginBasicVideoWasmOperationHost<TChapterOperationItem>
{
    private readonly PluginBasicVideoWasmHostOptions<TChapterOperationItem> _options;
    ...
    /// <summary>
    /// Initializes the standard video WASM host with the supplied response metadata and defaults.
    /// </summary>
    /// <param name="options">The host options describing the standard operation responses and JSON type metadata.</param>
    protected PluginBasicVideoWasmOperationHost(PluginBasicVideoWasmHostOptions<TChapterOperationItem> options)
    {
        _options = options;
        ...
        var builder = new PluginWasmHostBuilder()
            ...
            .AddStandardVideoCliOperations(
                ...
                VideoStreamsForCli,
                _options.VideoStreamArrayTypeInfo,
        ...
        builder.ConfigureInvoke(dispatcher => ConfigureCustomInvokeHandlers(
            dispatcher
                ...
                .RegisterVideoOperations(
                    videoStreams: request => PluginWasmVideoOperationScaffold.InvokeVideoStreams(
                        request,
                        mediaId => [.. GetVideoStreams(mediaId)],
                        _options.VideoStreamArrayTypeInfo),
                    videoSegment: request => PluginWasmVideoOperationScaffold.InvokeVideoSegment(
                        request,
                        GetVideoSegment,
                        _options.VideoSegmentTypeInfo),
                    supportsVideoRequests: SupportsVideoRequests)
    ...
    private string SerializeVideoSegmentForCli(string[] args, string _)
    {
        ...
        return segment is null
            ? "null"
            : JsonSerializer.Serialize(segment, _options.VideoSegmentTypeInfo);
    }
