...
[JsonSerializable(typeof(PluginManifestPreferences))]
[JsonSerializable(typeof(PluginManifestPreferenceCategory))]
[JsonSerializable(typeof(PluginManifestPreferenceField))]
[JsonSerializable(typeof(PluginManifestPreferenceOption))]
[JsonSerializable(typeof(PluginManifestPreferenceSecretOptions))]
[JsonSerializable(typeof(PluginManifestPreferenceVisibilityRule))]
[JsonSerializable(typeof(PluginManifestSearchQueryOptions))]
[JsonSerializable(typeof(PluginManifestSearchQueryAddition))]
[JsonSerializable(typeof(List<PluginManifestPreferenceCategory>))]
[JsonSerializable(typeof(List<PluginManifestPreferenceField>))]
[JsonSerializable(typeof(List<PluginManifestPreferenceOption>))]
