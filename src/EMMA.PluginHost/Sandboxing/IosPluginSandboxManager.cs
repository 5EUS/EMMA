    ...
    : PluginSandboxManagerBase(options, logger)
{
    ...
    /// <summary>
    /// Prepares sandbox resources for iOS-hosted plugins.
    /// </summary>
    /// <param name="manifest">The plugin manifest.</param>
    /// <param name="pluginRoot">The plugin sandbox root path.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A task that completes with <see langword="true"/> because iOS already provides OS-level sandboxing.</returns>
