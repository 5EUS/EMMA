...
/// <summary>
/// AspNet runtime implementation for search, chapter, page, and video provider calls.
/// </summary>
    ...
    : IPluginPagedMediaRuntime, IPluginVideoRuntime
{
    ...
    /// <summary>
    /// Sends HTTP requests with simple throttling, retry, and TLS-fallback behavior.
    /// </summary>
